...
public:
	...
	XmlNode(int t, const String& tag,const String& val="") :XmlBase(tag,val), m_nNodeType(t){}
	...
	String GetAttributeAndRemove(const String& attr_name);
	...
	typedef intrusive_list<XmlAttribute, policy_node_next<XmlAttribute> > AttrList;
	typedef intrusive_list<XmlNode, policy_node_next<XmlNode> > NodeList;
