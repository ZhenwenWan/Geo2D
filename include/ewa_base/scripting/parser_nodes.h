...
public:
	...
	TNode_var(const String& v,int f):basetype(v)
	{
		flags.add(f);
	}
...
class DLLIMPEXP_EWA_BASE TNode_expression_with_init : public  TNode_item
{
public:
	typedef TNode_item basetype;
	TNode_expression_with_init(){}
	TNode_expression_with_init(const String& s) :basetype(s){}

	TNode_expression_with_init(const tokItem& item) :basetype(item){}

	DataPtrT<TNode_statement> stmt_init;
	DataPtrT<TNode_expression> expr_item;

	CG_Block tScope;

	SYNTAX_TNODE_ACCEPT(TNode_expression_with_init);
};
...
public:
	...
	TNode_expression* DoClone(ObjectCloneState&)
	{
		return this;
	}
...
public:
	...
	String val_temp;
	DataPtrT<TNode_expression> val_expr;
...
public:
	...
	enum
	{
		...
		FLAG_CAPTURE_BY_VAL	=FLAG_MIN<<3,
		FLAG_MAX			=FLAG_MIN<<4,
	};
...
public:
	...
	TNode_expression_arr(const tokItem& item = tokItem());

	TNode_expression_arr(const TNode_expression_arr& node) 
		: basetype(node)
		, tbl(node.tbl)
...
public:
	...
	TNode_statement_block() {}
	TNode_statement_block(const TNode_statement_list& b) : basetype(b) {}
...
public:
	...
	public:
		...
		void set_block(DataPtrT<TNode_statement_list> p)
		{
			case_stmt.reset(dynamic_cast<TNode_statement_block*>(p.get()));
			if (!p||case_stmt)
			{
				return;
			}
			case_stmt.reset(new TNode_statement_block(*p));
		}
	};

	typedef DataGrpT<case_item>::iterator case_iterator;


	DataPtrT<TNode_expression> expr_cond;
	DataGrpT<case_item> case_list;
...
class DLLIMPEXP_EWA_BASE TNode_statement_cond_with_init : public  TNode_statement
{
public:
	typedef TNode_statement basetype;
	TNode_statement_cond_with_init(){}
	TNode_statement_cond_with_init(const String& s) :basetype(s){}
	TNode_statement_cond_with_init(const tokItem& item) :basetype(item){}
...
class DLLIMPEXP_EWA_BASE TNode_statement_if : public TNode_statement_cond_with_init
{
public:
	typedef TNode_statement_cond_with_init basetype;
...
public:
	...
	TNode_statement_control():level(0){}
	TNode_statement_control(const String& v):basetype(v),level(0){}
	TNode_statement_control(const tokItem& v):basetype(v),level(0){}
...
class DLLIMPEXP_EWA_BASE TNode_statement_loop : public TNode_statement_cond_with_init
{
public:
	typedef TNode_statement_cond_with_init basetype;
