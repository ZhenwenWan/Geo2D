...
protected:
	...
	indexer_map<String,BitFlags>& aKeyword;

	ScannerBase(indexer_map<String, BitFlags>&);
...
public:
	...
	bool parse(const String& p,bool flag);
	bool parse(const char* p1,const char* p2, bool flag);
