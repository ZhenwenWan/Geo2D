...
class DLLIMPEXP_EWA_BASE TNode_expression_with_init;
...
public:
	...
	static bool is_simple_var(TNode_expression* p);
	...
	virtual VisReturnType visit(TNode_expression_with_init*,VisExtraParam){return def_value();}
...
public:
	...
	virtual VisReturnType visit(TNode_extern1*,VisExtraParam){return def_value();}
	virtual VisReturnType visit(TNode_expression_with_init*, VisExtraParam);
