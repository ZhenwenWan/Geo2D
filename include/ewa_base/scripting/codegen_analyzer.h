...
public:
	...
	void define_export(const String& n, const String& m);

	void getvar(const String& v);
	void setvar(const String& v);

	CG_Variable* handle_var(const String& v);
...
protected:
	...
	void handle_var_capture(StackFrameInfoAnalyzer& sfa, CG_Variable* q, const String& v, int nf);
