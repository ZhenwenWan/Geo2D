...
template<typename X0>
class FunctorImpl<X0&> : public FunctorImpl<X0>
{
public:
...
public:
	...
	static inline Rt g(EW_ARG(Ft) ft,EW_ARG(K1) k1,EW_ARG(K2) k2,EW_ARG(K3) k3,EW_ARG(K4) k4,EW_ARG(K5) k5,EW_ARG(K6) k6,EW_ARG(K7) k7,EW_ARG(K8) k8)
	{
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return ft(EW_FORWARD(K1, k1),EW_FORWARD(K2,k2));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return ft(EW_FORWARD(K1, k1), EW_FORWARD(K2, k2), EW_FORWARD(K3,k3));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return (k1->*ft)(EW_FORWARD(K2, k2), EW_FORWARD(K3, k3));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return ft(EW_FORWARD(K1, k1), EW_FORWARD(K2, k2), EW_FORWARD(K3, k3),EW_FORWARD(K4,k4));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return (k1->*ft)(EW_FORWARD(K2, k2), EW_FORWARD(K3, k3), EW_FORWARD(K4, k4));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return ft(EW_FORWARD(K1, k1), EW_FORWARD(K2, k2), EW_FORWARD(K3, k3), EW_FORWARD(K4, k4), EW_FORWARD(K5,k5));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return (k1->*ft)(EW_FORWARD(K2, k2), EW_FORWARD(K3, k3), EW_FORWARD(K4, k4), EW_FORWARD(K5, k5));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return ft(EW_FORWARD(K1, k1), EW_FORWARD(K2, k2), EW_FORWARD(K3, k3), EW_FORWARD(K4, k4), EW_FORWARD(K5, k5), EW_FORWARD(K6,k6));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return (k1->*ft)(EW_FORWARD(K2, k2), EW_FORWARD(K3, k3), EW_FORWARD(K4, k4), EW_FORWARD(K5, k5), EW_FORWARD(K6, k6));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return ft(EW_FORWARD(K1, k1), EW_FORWARD(K2, k2), EW_FORWARD(K3, k3), EW_FORWARD(K4, k4), EW_FORWARD(K5, k5), EW_FORWARD(K6, k6), EW_FORWARD(K7,k7));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return (k1->*ft)(EW_FORWARD(K2, k2), EW_FORWARD(K3, k3), EW_FORWARD(K4, k4), EW_FORWARD(K5, k5), EW_FORWARD(K6, k6), EW_FORWARD(K7, k7));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return ft(EW_FORWARD(K1, k1), EW_FORWARD(K2, k2), EW_FORWARD(K3, k3), EW_FORWARD(K4, k4), EW_FORWARD(K5, k5), EW_FORWARD(K6, k6), EW_FORWARD(K7, k7), EW_FORWARD(K8,k8));
	}
};
...
public:
	...
	{
		BINDIMPL_UNUSED_PARAM();
		return (k1->*ft)(EW_FORWARD(K2, k2), EW_FORWARD(K3, k3), EW_FORWARD(K4, k4), EW_FORWARD(K5, k5), EW_FORWARD(K6, k6), EW_FORWARD(K7, k7), EW_FORWARD(K8, k8));
	}
};
...
{
public:
	static inline K0 g(EW_ARG(K0) k0,EW_ARG(K1) k1=K1(),EW_ARG(K2) k2=K2(),EW_ARG(K3) k3=K3(),EW_ARG(K4) k4=K4(),EW_ARG(K5) k5=K5(),EW_ARG(K6) k6=K6(),EW_ARG(K7) k7=K7(),EW_ARG(K8) k8=K8())
	{
		BINDIMPL_UNUSED_PARAM();
		return EW_FORWARD(K0,k0);
	}
};
...
#define PARM_SELECTION(X) \
	...
	public:\
		...
		static inline K##X g(EW_ARG(K0) k0,EW_ARG(K1) k1=K1(),EW_ARG(K2) k2=K2(),EW_ARG(K3) k3=K3(),EW_ARG(K4) k4=K4(),EW_ARG(K5) k5=K5(),EW_ARG(K6) k6=K6(),EW_ARG(K7) k7=K7(),EW_ARG(K8) k8=K8())\
		{\
			(void)&k0;\
			(void)&k1;(void)&k2;(void)&k3;(void)&k4;\
			(void)&k5;(void)&k6;(void)&k7;(void)&k8;\
			return EW_FORWARD(K##X,k##X);\
		}\
	};
...
public:
	...
	BindImpl(EW_ARG(P0) p0):data(EW_FORWARD(P0,p0)){}
};
...
public:
	...
	BindImpl(EW_ARG(P0) p0, EW_ARG(P1) p1)
		:data(EW_FORWARD(P0, p0), EW_FORWARD(P1, p1)){}
};
...
public:
	...
	BindImpl(EW_ARG(P0) p0, EW_ARG(P1) p1, EW_ARG(P2) p2)
		:data(EW_FORWARD(P0, p0), EW_FORWARD(P1, p1), EW_FORWARD(P2, p2)){}
};
...
public:
	...
	BindImpl(EW_ARG(P0) p0, EW_ARG(P1) p1, EW_ARG(P2) p2, EW_ARG(P3) p3)
		:data(EW_FORWARD(P0, p0), EW_FORWARD(P1, p1), EW_FORWARD(P2, p2), EW_FORWARD(P3, p3)){}
};
...
public:
	...
	BindImpl(EW_ARG(P0) p0, EW_ARG(P1) p1, EW_ARG(P2) p2, EW_ARG(P3) p3, EW_ARG(P4) p4)
		:data(EW_FORWARD(P0, p0), EW_FORWARD(P1, p1), EW_FORWARD(P2, p2), EW_FORWARD(P3, p3), EW_FORWARD(P4, p4)){}
};
...
public:
	...
	BindImpl(EW_ARG(P0) p0, EW_ARG(P1) p1, EW_ARG(P2) p2, EW_ARG(P3) p3, EW_ARG(P4) p4, EW_ARG(P5) p5)
		:data(EW_FORWARD(P0, p0), EW_FORWARD(P1, p1), EW_FORWARD(P2, p2), EW_FORWARD(P3, p3), EW_FORWARD(P4, p4), EW_FORWARD(P5, p5)){}
};
...
public:
	...
	BindImpl(EW_ARG(P0) p0, EW_ARG(P1) p1, EW_ARG(P2) p2, EW_ARG(P3) p3, EW_ARG(P4) p4, EW_ARG(P5) p5, EW_ARG(P6) p6)
		:data(EW_FORWARD(P0, p0), EW_FORWARD(P1, p1), EW_FORWARD(P2, p2), EW_FORWARD(P3, p3), EW_FORWARD(P4, p4), EW_FORWARD(P5, p5), EW_FORWARD(P6, p6)){}
};
...
public:
	...
	BindImpl(EW_ARG(P0) p0, EW_ARG(P1) p1, EW_ARG(P2) p2, EW_ARG(P3) p3, EW_ARG(P4) p4, EW_ARG(P5) p5, EW_ARG(P6) p6, EW_ARG(P7) p7)
		:data(EW_FORWARD(P0, p0), EW_FORWARD(P1, p1), EW_FORWARD(P2, p2), EW_FORWARD(P3, p3), EW_FORWARD(P4, p4), EW_FORWARD(P5, p5), EW_FORWARD(P6, p6), EW_FORWARD(P7, p7)){}
};
...
public:
	...
	BindImpl(EW_ARG(P0) p0,EW_ARG(P1) p1,EW_ARG(P2) p2,EW_ARG(P3) p3,EW_ARG(P4) p4,EW_ARG(P5) p5,EW_ARG(P6) p6,EW_ARG(P7) p7,EW_ARG(P8) p8)
		:data(EW_FORWARD(P0,p0),EW_FORWARD(P1,p1),EW_FORWARD(P2,p2),EW_FORWARD(P3,p3),EW_FORWARD(P4,p4),EW_FORWARD(P5,p5),EW_FORWARD(P6,p6),EW_FORWARD(P7,p7),EW_FORWARD(P8,p8)){}
};
