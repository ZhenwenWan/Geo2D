...
public:
	...
	static EW_NORETURN void XError(const char* p, bool copy_=true);

	// Throw std::bad_alloc
	static EW_NORETURN void XBadAlloc();
	static EW_NORETURN void XBadAlloc(size_t n);
	static EW_NORETURN void XBadAlloc(size_t n,const char* m);
	static EW_NORETURN void XBadAlloc_count(size_t n);
	...
	static EW_NORETURN void XMatrixSizeNotMatch();
	static EW_NORETURN void XArraySizeNotMatch();
...
protected:
	...
	void _copy_str(const char* p, bool d) throw();
	void _tidy() throw();
