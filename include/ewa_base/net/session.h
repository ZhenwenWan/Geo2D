...
class DLLIMPEXP_EWA_BASE AsyncPool;

class DLLIMPEXP_EWA_BASE Session : public CallableObject, public ISessionBase
{
public:
	...
	AsyncPool* GetIOCPPool(){ return hiocp; }
...
protected:
	...
	void StartSession(Session*,AsyncPool* h=NULL);
