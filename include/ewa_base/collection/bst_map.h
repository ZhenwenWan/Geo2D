...
namespace std
{
	template<typename K, typename V, typename C, typename A, template<typename, typename, typename> class P>
	void swap(ew::bst_map<K, V, C, A, P>& v1, ew::bst_map<K, V, C, A, P>& v2)
	{
		v1.swap(v2);
	}
	template<typename K, typename V, typename C, typename A, template<typename, typename, typename> class P>
	void swap(ew::bst_multimap<K, V, C, A, P>& v1, ew::bst_multimap<K, V, C, A, P>& v2)
	{
		v1.swap(v2);
	}
}
