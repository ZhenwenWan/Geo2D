...
namespace std
{
	template<typename T, typename C, typename A, template<typename, typename, typename> class P>
	void swap(ew::bst_set<T, C, A, P>& v1, ew::bst_set<T, C, A, P>& v2)
	{
		v1.swap(v2);
	}
	template<typename T, typename C, typename A, template<typename, typename, typename> class P>
	void swap(ew::bst_multiset<T, C, A, P>& v1, ew::bst_multiset<T, C, A, P>& v2)
	{
		v1.swap(v2);
	}
}
