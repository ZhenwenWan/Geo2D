...
namespace tl
{
	...
	namespace detail
	{
		...
		template<>
		class test_empty_n<bool,1> : public value_type<false> {};
...
// ----------------------------------------------------------------------------------------
	...
	namespace detail
	{
		...
		struct is_convertible_helper
		{
			...
			const static bool value = sizeof(test(make_from())) == sizeof(char);
		};
		template <typename from, typename to>
...
// ----------------------------------------------------------------------------------------
	...
	typedef mk_typelist<unsigned char,unsigned short,unsigned int,unsigned long,unsigned long long>::type unsigned_integer_types;
	typedef signed_integer_type::cat<unsigned_integer_types>::type integer_type;
...
// ----------------------------------------------------------------------------------------
	...
	template<>
	struct is_pod<int> : public value_type<true> {};

	template<typename T>
	struct is_pod<T*> : public value_type<true> {};
